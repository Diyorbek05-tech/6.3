...
import chefburgers from '../assets/chefburgers.png'
import grandAI from '../assets/grandAI.png'
import butterbrot from '../assets/butterbrot.png'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {deals.map((deal, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-top from-black/80 to-transparent p-6">
